...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="mynavbar" style="">
...
<div class="container">
  ...
  <form action="addjob.php" method="post" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="name" placeholder="company name" name="company" required>
